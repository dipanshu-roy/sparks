        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                <div class="form-container">
                    ...
                    @endif
                    <form action="{{ route('save.head.of.school') }}" id="register_head" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="second_name" id="second_name" @if(!empty($head_of_school)) value="{{ $head_of_school->second_name }}" @endif placeholder="Enter Middle Name">
                                    @error('second_name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="designation" class="form-select" aria-label="Select Designation" required id="designation-dropdown">
                                        <option value="">--Select Designation--</option>
                                        @foreach ($designation as $d)
                                            <option value="{{ $d->id }}" {{ isset($head_of_school) && $head_of_school->designation == $d->id ? 'selected' : '' }}>{{ $d->designation }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
