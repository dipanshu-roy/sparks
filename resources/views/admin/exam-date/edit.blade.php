                                    ...
                                    <div class="card">
                                        ...
                                        @endphp
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="exam_fee"  placeholder="Exam Fee" value="{{$edit->exam_fee}}" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="Subject">Fee Dicsount</label>
                                                            <input type="text" class="form-control" name="discount"  placeholder="Fee Dicsount" value="{{$edit->discount}}" required>
                                                        </div>
                                                        
                                                        
                                                        <div class="form-group">
                                                            <label for="Exam Date">Exam Date</label>
                                                            <input type="date" value="{{$edit->shedule_date}}" class="form-control" name="shedule_date"  placeholder="Exam Date" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="Exam End Date">Exam End Date</label>
                                                            <input type="date" value="{{$edit->exam_end_date}}" class="form-control" name="exam_end_date"  placeholder="Exam End Date" required>
                                                        </div>
